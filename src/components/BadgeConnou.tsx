...
const BadgeConnou: FC<BadgeProps> = ({ ...props }) => {
  return (
    <span className="group inline">
      ...
      >
        <span className="translate-y-0 skew-y-0 transition duration-500 group-hover:-translate-y-[170%] group-hover:skew-y-12 flex items-center">
          Connou
        </span>
        <span className="absolute translate-y-[150%] skew-y-12 transition duration-500 group-hover:translate-y-0 group-hover:skew-y-0 flex items-center">
          Connou
        </span>
      </a>
    </span>
